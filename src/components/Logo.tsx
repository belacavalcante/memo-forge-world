  ...
  return (
    <div className="flex items-center gap-2">
      <div className="gradient-primary p-1.5 rounded-lg shadow-glow">
        <BrainCircuit className={`${iconSizes[size]} text-primary-foreground`} strokeWidth={2.5} />
      </div>
      <span className={`font-semibold tracking-tight ${sizes[size]}`}>Mindy Academy</span>
    </div>
  );
};